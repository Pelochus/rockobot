...
const uint8_t DIRECTION_CHANGE_THRESHOLD = 20; // If difference between sensors is higher than this, change direction while searching
const uint8_t US_NEARBY_ENEMY = 30;
const uint8_t FULL_POWER_NEAR_ENEMY = 10;
